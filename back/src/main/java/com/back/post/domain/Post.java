...
public class Post {
    ...
    protected Post() {}
    public Post(User user, Course course, String caption, String photoUrl, LocalDateTime walkedAt) {
        this.user = user; this.course = course; this.caption = caption; this.photoUrl = photoUrl;

...
public class Post {
    ...
    protected Post() {}
    public Post(User user, Course course, String title, String content, String photoUrl, LocalDateTime walkedAt) {
        this.user = user; this.course = course; this.title = title; this.content = content; this.photoUrl = photoUrl;

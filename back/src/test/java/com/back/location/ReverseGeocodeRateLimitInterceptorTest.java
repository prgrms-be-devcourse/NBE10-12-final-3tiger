...
class ReverseGeocodeRateLimitInterceptorTest {

    private final ReverseGeocodeRateLimiter rateLimiter =
            mock(ReverseGeocodeRateLimiter.class);
    private final ReverseGeocodeRateLimitInterceptor interceptor =
            new ReverseGeocodeRateLimitInterceptor(rateLimiter);

...
CREATE TABLE grid_score (
    ...
    shade_summer_hourly NUMERIC(4, 3)[],
    shade_winter_hourly NUMERIC(4, 3)[],
...
INSERT INTO grid_score VALUES
    (1, '11500', ST_SetSRID(ST_MakePoint(126.805, 37.505), 4326),
     0.100, 0.200, 0.300,
     ARRAY[0.10,0.20,0.30,0.40,0.50,0.60,0.70]::NUMERIC(4,3)[],
     ARRAY[0.15,0.25,0.35,0.45,0.55,0.65]::NUMERIC(4,3)[],
    ...
    (3, '11500', ST_SetSRID(ST_MakePoint(126.811, 37.511), 4326),
     1.000, 1.000, 1.000,
     ARRAY[1.000,1.000,1.000,1.000,1.000,1.000,1.000]::NUMERIC(4,3)[],
     ARRAY[1.000,1.000,1.000,1.000,1.000,1.000]::NUMERIC(4,3)[],

    ...
    <SafeAreaView className="flex-1 bg-[#F6FBF6]">
      ...
      >
        ...
        >
              ...
              <View className="flex-row gap-2">
                <View className="h-14 flex-1 flex-row items-center gap-2.5 rounded-xl border border-[#BCCBB9] bg-white px-[15px]">
                  ...
                  <TextInput
                    ...
                    secureTextEntry={index === 1 || index === 2}
                    autoCapitalize={index === 0 ? "none" : undefined}
                  />
                </View>
                {index === 0 && (
                  <Pressable
                    className={`h-14 w-[82px] items-center justify-center rounded-xl border border-[#22C55E] ${checked ? "bg-[#DDF8E5]" : ""}`}
          ...
          <Pressable
            className="mt-7 h-14 items-center justify-center rounded-xl bg-[#006E2F]"
